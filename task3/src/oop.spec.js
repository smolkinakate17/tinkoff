...
describe('ООП', () => {
    describe('#Point', () => {
        ...
        it('Получение расстояния до начала координат', () => {
            const point = new core.Point(3, 4);
            const point2 = new core.Point(0, 0);

            assert.strictEqual(point.getDistance(), 5)
            assert.strictEqual(point2.getDistance(), 0)
        })
    });
